...
module.exports.connect = function websocketsActivitySubscribe(antisocialApp, currentUser, friend) {
...
module.exports.disconnect = function websocketsActivitySubscribe(antisocialApp, config, dbAdaptor, currentUser, friend) {
